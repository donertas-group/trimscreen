...
def parse_args():
    ...
    parser.add_argument("-D", "--dataset", required=True, type=str, help="Dataset directory name (e.g., 2025_10_01)")
    parser.add_argument("-C", "--column", required=True, type=str, choices=["retained_reads_percent", "Phylum_pasv", "Genus_pasv"],
...
#        full_avg["y"],
 #       c=full_avg[column],
  #      cmap="viridis",
   #     alpha=full_avg["is_filtered"].map({True: 1.0, False: 0.5}),
    #    edgecolor="none"
    #)
